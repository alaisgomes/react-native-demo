...
function api_v1_product_create(payload) {
  return backendDeployAPI.post(`/api/v1/product/`, null, { data: payload.data })
}
...
function api_v1_product_update(payload) {
  return backendDeployAPI.put(`/api/v1/product/${payload.id}/`, null, {
    data: payload.data
  })
}
function api_v1_product_partial_update(payload) {
  return backendDeployAPI.patch(`/api/v1/product/${payload.id}/`, null, {
    data: payload.data
  })
}
...
function api_v1_user_create(payload) {
  return backendDeployAPI.post(`/api/v1/user/`, null, { data: payload.data })
}
function api_v1_user_read(payload) {
  return backendDeployAPI.get(`/api/v1/user/${payload.id}/`)
}
function api_v1_user_update(payload) {
  return backendDeployAPI.put(`/api/v1/user/${payload.id}/`, null, {
    data: payload.data
  })
}
function api_v1_user_partial_update(payload) {
  return backendDeployAPI.patch(`/api/v1/user/${payload.id}/`, null, {
    data: payload.data
  })
}
